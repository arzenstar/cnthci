Blog Search<?php 
        ...
        $mysql=mysql_query("SELECT * FROM posting WHERE idpost=$id");
        $cek=mysql_fetch_assoc($mysql);?>
<div class="container">
        ...
        <div class="col-lg-8">
            ...
            <script>
                ...
                <div class="">
                    ...
                    <form class="form-horizontal"  action="<?php echo base_url();?>index.php/page/updatepost" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        <input name="id" value="<?php echo $cek['idpost'] ?>" style="visibility:hidden;">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Judul Posting</label>
                            <div class="col-sm-9">
                                <input class="form-control" type="text" name="judul" placeholder="Judul Postingan" value="<?php echo $cek['judul']?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea id="editor" name="area"><?php echo $cek['isi']?></textarea>
                            </div>
                        </div>
