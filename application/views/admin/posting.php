<?php                   $update=$this->input->get('update');
            ...
            <div class="container-fluid">
                ...
                <div class="">
                    ...
                    <form class="form-horizontal"  action="<?php echo base_url();?>index.php/admin/updatehomepage/<?php echo $item['idpost']?>" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input class="form-control" type="text" id="image" name="file1" placeholder="Image" value="<?php echo $file['nm_file'];?>" required>
